...
describe("test activations.utils", () => {
  ...
  test("test activations.utils getEnergieKWh", () => {
    expect(getEnergieKWh(TEST_PLAQUE_CHAUFFANTE)).toBe(
      (90 * 800) / (1000 * 60),
    );
  });

  test("test activations.utils getPrixEnergie", () => {
    expect(getPrixEnergie(TEST_PLAQUE_CHAUFFANTE)).toBe(
