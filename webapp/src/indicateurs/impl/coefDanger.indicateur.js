...
export class CoefDangerIndicateur extends Indicateur {
    ...
    reactionPrincipale( reaction ){
        ...
        */
        ...
        const coefDangerReactifs = this.reactionService.coefDangerReactifs( reaction );
        const coefDangerCatalyseurs = this.reactionService.coefDangerCatalyseurs( reaction );
        const coefDangerSolvants = this.reactionService.coefDangerSolvants( reaction );

        return ( coefDangerReactifs + coefDangerSolvants + coefDangerCatalyseurs ) / masseReactionPrincipale;
    };
    ...
    reactionComplete( reaction ){
        ...
        */
        ...
        const coefDangerCatalyseurs = this.reactionService.coefDangerCatalyseurs( reaction );
        const coefDangerSolvants = this.reactionService.coefDangerSolvants( reaction );
        const coefDangerPostTraitement = this.reactionService.coefDangerPostTraitement( reaction );
        const coefDangerPurification = this.reactionService.coefDangerPurification( reaction );
        const sumCoefDanger = coefDangerReactifs 
                        + coefDangerSolvants 
