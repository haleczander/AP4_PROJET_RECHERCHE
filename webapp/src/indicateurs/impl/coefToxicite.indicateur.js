...
import { getCoefDanger, getDanger, getMassePureteG } from "../../utils/molecules.utils";
...
export class CoefToxiciteIndicateur extends Indicateur {
    ...
    reactionPrincipale( reaction ){
        ...
        */
        ...
        const coefToxiciteReactifs = this.reactionService.coefToxiciteReactifs( reaction );
        const coefToxiciteCatalyseurs = this.reactionService.coefToxiciteCatalyseurs( reaction );
        const coefToxiciteSolvants = this.reactionService.coefToxiciteSolvants( reaction );

        return ( coefToxiciteReactifs + coefToxiciteSolvants + coefToxiciteCatalyseurs ) / masseReactionPrincipale;
    };
    ...
    reactionComplete( reaction ){
        ...
        */
        ...
        const coefToxiciteCatalyseurs = this.reactionService.coefToxiciteCatalyseurs( reaction );
        const coefToxiciteSolvants = this.reactionService.coefToxiciteSolvants( reaction );
        const coefToxicitePostTraitement = this.reactionService.coefToxicitePostTraitement( reaction );
        const coefToxicitePurification = this.reactionService.coefToxicitePurification( reaction );

        const sumCoefToxicite = coefToxiciteReactifs 
